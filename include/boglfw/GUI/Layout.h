...
protected:
	...
	static glm::vec2 setElementSize(std::shared_ptr<GuiBasicElement> el, glm::vec2 size);
	// returns the user-set position of the element
	static glm::vec2 getElementUserPos(std::shared_ptr<GuiBasicElement> el);
	// returns the user-set size of the element
	static glm::vec2 getElementUserSize(std::shared_ptr<GuiBasicElement> el);
